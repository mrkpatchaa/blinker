...
const launchApplication = () => {
  ...
  contextMenu = Menu.buildFromTemplate([
    ...
    { type: "separator" },
    {
      ...
      sublabel:
        "If this option is enabled, application will start on system startup",
    ...
    { type: "separator" },
    {
      ...
      sublabel:
        "If this option is enabled, a sound will be played on every notification",
      checked: playSound,
      click() {
        toggleSound();
      },
  ...
  appAutoLauncher
    ...
    .then(function (isEnabled) {
      ...
      appAutoLauncher.enable().then(function () {
